    ...
    <main className="min-h-screen bg-gradient-to-b from-rose-50/70 via-white to-rose-100/70">
      ...
      <div className="container mx-auto px-4 pb-16">
        <div className="max-w-5xl mx-auto -mt-24 relative z-20">
          <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-xl border border-rose-100/80 px-4 py-4 md:px-6 md:py-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center flex-1 bg-gray-50/60 rounded-2xl px-3 py-2 md:px-4 md:py-2 border border-gray-200/80 focus-within:ring-4 focus-within:ring-primary/10 transition-all duration-300">
              ...
              <input
                ...
                className="w-full bg-transparent border-none focus:ring-0 text-sm md:text-base text-gray-800 placeholder-gray-400 px-3 py-2 outline-none"
              />
              {query && (
                <button
                  onClick={() => setQuery('')}
                  className="p-1.5 md:p-2 ml-1 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full transition-colors"
                >
                  <X className="w-4 h-4" />
                </button>
              )}
                ...
                <button
                  ...
                  className={`px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-medium rounded-full transition-all duration-300 border ${
                    category === cat
                      ...
                      : 'bg-white/80 border-gray-200 text-gray-600 hover:border-primary/50 hover:text-primary hover:bg-rose-50'
                  }`}
                >
                  {cat}
                </button>
        ...
        <div className="mt-16">
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="card p-4">
                  ...
                  <div className="h-6 w-3/4 bg-gray-100 rounded-md mb-2 animate-pulse" />
                  <div className="h-4 w-full bg-gray-100 rounded-md mb-4 animate-pulse" />
              ...
              {filtered.map((product) => (
                ...
                >
                  <Link
                    ...
                    className="card-strong bg-white/90 rounded-3xl overflow-hidden group transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 flex flex-col border border-rose-100/80 hover:border-rose-200/90"
                  >
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="flex items-center mb-3 text-xs md:text-sm text-gray-500">
                        <span
            ...
            <div className="text-center py-20 card bg-gray-50/70">
